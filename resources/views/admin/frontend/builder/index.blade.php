                            ...
                            @if ($pdata->secs != null)
                                @foreach (json_decode($pdata->secs) as $sec)
                                    <li class="highlight icon-move item">
                                        ...
                                        <span class="d-inline-block me-auto ml-2 text-white"> {{ __(@$sections[$sec]['name']) }}</span>
                                        <i class="d-inline-block remove-icon fa fa-times ml-auto"></i>
                                ...
                                <li class="highlight icon-move clearfix">
                                    ...
                                    @if ($secs['builder'])
                                        <div class="float-end d-inline-block manage-content">
                                            <a href="{{ route('admin.frontend.sections', $k) }}" target="_blank" class="btn btn-outline-light cog-btn text-center text-white" title="@lang('Manage Content')">
...
@push('script-lib')
    <script src="{{ asset('assets/viser_admin/js/jquery-sortable.js') }}"></script>
@endpush
