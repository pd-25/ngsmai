            ...
            <div class="card b-radius--10">
                <div class="card-body p-0">
                    <div class="table-responsive--md table-responsive" id="printContainer">
                                ...
                                @forelse ($bookings as $item)
                                    <tr>
                                        ...
                                        <td style="text-align:left;" data-label="@lang('Booking Number')">
                                            ...
                                            <a href="{{ route('admin.booking.details', $item->id) }}">
                                                {{ __($item->booking_number) }}
                                        ...
                                        <td style="text-align:left;" data-label="@lang('Booked For')">
                                            {{ showDateTime($item->booked_room_min_booked_for, 'd M, Y') }}
                                            <span class="text--info">@lang('to')</span>
                                            {{ showDateTime($item->booked_room_max_booked_for, 'd M, Y') }}
                                        </td>
                                        {{-- <td style="text-align: left; display:none;" data-label="@lang('Total Fare | Extra Service')">
                        ...
                        <span style="float:right;" class="text--info pr-70">@lang('Total Due Payment') =
                            {{ number_format($totalDuePayment, 2) }}</span>
                        <!-- table end -->
                    </div>
                </div>
            ...
            <form action="" method="GET" class="form-inline">
                <div class="input-group justify-content-end">
                    ...
                    <input name="date" type="text" data-range="true" data-multiple-dates-separator=" - "
                        ...
                        placeholder="@lang('From - To')" autocomplete="off" value="{{ request()->date }}">
