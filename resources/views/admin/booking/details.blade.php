                                                ...
                                                @elseif($item->status == 9)
                                                    ...
                                                    <div class="bg--18 room-container rounded p-2">
                                                        ...
                                                        @if (now()->toDateString() < $item->booked_for)
                                                            <button type="button" class="cancel-btn confirmationBtn" data-question="@lang('Are you sure, you want to cancel this booked room/bed?')" data-action="{{ route('receptionist.booked.room.cancel', $item->id) }}"><i class="las la-times"></i>
                                                            </button>
