                        ...
                        @if($message->admin_id == 0)
                            ...
                            <div class="row border border--primary border-radius-3 my-3 mx-2">
                                ...
                                <div class="col-md-3 border-end text-end">
                                    ...
                                    @endif
                                    <button data-id="{{$message->id}}" type="button" data-bs-toggle="modal" data-bs-target="#DelMessage" class="btn btn-danger btn-sm my-3 delete-message"><i class="la la-trash"></i> @lang('Delete')</button>
                                </div>
