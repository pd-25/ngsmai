                            ...
                            <div class="payment-method-header">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview" style="background-image: url('{{ getImage(getFilePath('gateway').'/'. $gateway->image,getFileSize('gateway')) }}')"></div>
                                    </div>
                            ...
                            @foreach($gateway->currencies as $gatewayCurrency)
                                ...
                                <div class="payment-method-item block-item child--item">
                                    <div class="payment-method-header">
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url('{{getImage(getFilePath('gateway').'/'.$gatewayCurrency->image,getFileSize('gateway'))}}')"></div>
                                            </div>
                                            <div class="avatar-edit">
                                                <input type="file" name="currency[{{ $currencyIndex }}][image]" id="image{{ $currencyIndex }}" class="profilePicUpload" accept=".png, .jpg, .jpeg"/>
                                                <label for="image{{ $currencyIndex }}" class="bg--primary"><i class="la la-pencil"></i
                                                    ></label>
                                            </div>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview"
                                             style="background-image: url('{{getImage(getFilePath('gateway'),getFileSize('gateway'))}}')">

                                        </div>
                                    </div>
                                    <div class="avatar-edit">
                                        <input disabled type="file" accept=".png, .jpg, .jpeg" class="profilePicUpload" id="image{{ $currencyIndex }}" name="currency[{{ $currencyIndex }}][image]"/>
                                        <label for="image{{ $currencyIndex }}" class="bg--primary"><i class="la la-pencil"></i></label>
                                    </div>
                                </div>
                                <div class="content">
                                    <div class="d-flex justify-content-between">
...
@push('script')
    <script>
        (function ($) {
            ...
            console.log($('.payment-method-item.block-item'));
