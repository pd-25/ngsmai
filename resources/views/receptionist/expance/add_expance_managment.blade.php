            ...
            @endforeach
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                        data-action="{{ route('receptionist.expense_managment.remove',$item->id) }}"
...
<div id="cuModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('receptionist.expense_managment.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                 <input type ="hidden" value="{{  auth()->guard('receptionist')->id()}}" name="user_id">
