            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        @if($deposit->receptionist_feedback)
                            <li class="list-group-item">
                                <strong>@lang('Receptionist Response')</strong>
                                <br>
                                <p>{{__($deposit->receptionist_feedback)}}</p>
                            </li>
                        @endif
                    </ul>
                </div>
                    ...
                    @if($deposit->status == 2)
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                data-action="{{ route('receptionist.deposit.approve', $deposit->id) }}"
    ...
    <div id="rejectModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('receptionist.deposit.reject')}}" method="POST">
                    @csrf
