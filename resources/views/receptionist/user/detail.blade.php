    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--info overflow-hidden">
                        <a href="{{ route('receptionist.booking.all') }}?search={{ $user?->username }}" class="item-link"></a>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--success overflow-hidden">
                        <a href="{{ route('receptionist.booking.active') }}?search={{ $user?->username }}" class="item-link"></a>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--warning">
                        <a href="{{ route('receptionist.booking.request.all') }}?search={{ $user?->username }}" class="item-link"></a>
            ...
            {{-- <div class="row gy-4 justify-content-center mt-1" style="display:none;">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3 col-xxl-3">
                    <a href="{{ route('receptionist.report.login.history') }}?search={{ $user?->username }}" class="btn btn--info btn--shadow w-100 btn-lg">
                        <i class="las la-list-alt"></i>@lang('Logins')
                    </a>
                </div>

                <div class="col-sm-6 col-lg-4 col-xl-3 col-xxl-3">
                    <a href="{{ route('receptionist.users.login', $user?->id) }}" target="_blank" class="btn btn--dark btn--shadow w-100 btn-lg">
