                        ...
                        <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
                            ...
                            <div class="form-group flex-fill">
                                ...
                                <input name="date" type="text" data-range="true" data-multiple-dates-separator=" To "
                                    ...
                                    data-position='bottom left' placeholder="Select Date and Time" autocomplete="off"
                                    required>
                            ...
                            <div class="form-group flex-fill">
                                ...
                                <input name="rooms" class="form-control" type="text" placeholder="@lang('How many room?')"
                                    required>
                            </div>

                            <div class="form-group d-flex">
                                <button type="submit" class="btn btn--primary btn-sm m-1 w-100 h-45"><i
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('receptionist.room.book') }}" method="POST" class="booking-form"
                        id="booking-form">
                        @csrf
                        <input type="hidden" value="{{ auth()->guard('receptionist')->id() }}" name="booked_user_id">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <button type="button"
                                    class="btn btn--primary w-100 h-45 btn-book confirmBookingBtn">@lang('Book Now')</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        window.location.href = "{{ route('receptionist.booking.all') }}";
                    } else {
