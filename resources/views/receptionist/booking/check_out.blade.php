        ...
        <div class="col-xl-6 col-lg-8 col-md-8">
            <div class="card b-radius--10">
                ...
                <div class="card-footer py-3">
                    ...
                    <div class="text-end">
                        <button class="btn btn--dark confirmationBtn ms-1" @if ($dueAmount != 0) disabled @endif data-action="{{ route('receptionist.booking.checkout', $booking->id) }}" data-question="@lang('Are you sure, you want to check out this booking?')"><i class="las la-sign-out-alt"></i>@lang('Check Out')</button>
...
@push('breadcrumb-plugins')
    <div class="d-flex align-items-center justify-content-end flex-wrap gap-1">
        ...
        <a href="{{ route('receptionist.booking.invoice', $booking->id) }}" class="btn btn-sm btn-outline--info ms-1" target="_blank"><i class="las la-print"></i>@lang('Print')</a>
    </div>
@endpush
