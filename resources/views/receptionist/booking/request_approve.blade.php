...
@section('panel')
    <div class="row booking-wrapper gy-4">
        <div class="col-lg-8">
            <div class="card">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn--primary h-45 w-100 btn-book confirmationBtn" data-question="@lang('Are you sure to book this rooms?')" data-action="{{ route('receptionist.assign.room') }}">@lang('Book Now')</button>
