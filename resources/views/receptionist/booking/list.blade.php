...
@section('panel')
    <form style="display: flex;margin-bottom: 30px; margin-top: -73px; margin-left: 32%;"
        action="{{ route('receptionist.booking.filter_status') }}" method="post">
        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="@lang('Booking Number')">
                                            ...
                                            @if (now() >= $booking->booked_room_min_booked_for &&
                                                    now() <= $booking->booked_room_max_booked_for &&
                                                    $booking->status == 1)
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            <div class="d-flex justify-content-end flex-wrap gap-1">
                                                ...
                                                <a href="{{ route('receptionist.booking.details', $booking->id) }}"
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="{{ route('receptionist.booking.service.details', $booking->id) }}"
                                                        class="dropdown-item">
                                                    ...
                                                    @if ($booking->status == 1)
                                                        ...
                                                        @if (now() >= $booking->booked_room_min_booked_for)
                                                            <a href="{{ route('receptionist.booking.checkout', $booking->id) }}"
                                                                class="dropdown-item">
                                                    ...
                                                    <a href="{{ route('receptionist.booking.invoice', $booking->id) }}"
    ...
    <script>
        (function($) {
            ...
            $('.payBtn').on('click', function() {
                ...
                let action = `{{ route('receptionist.booking.payment.partial', '') }}/${id}`;
            ...
            $('.mergeBookingBtn').on('click', function(e) {
                ...
                form.action = `{{ route('receptionist.booking.merge', '') }}/${$(this).data('id')}`
