                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input  type="number" step="any" name="amount" class="form-control form--control" value="{{ session()->get('amount') }}" required>
                    ...
                    <div class="mt-4">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item justify-content-center crypto_currency d-none">
                                <span>@lang('Conversion with') <span class="method_currency"></span> @lang('and final value
                                    will Show on next step')</span>
                            </li>
                        </ul>
                    </div>
